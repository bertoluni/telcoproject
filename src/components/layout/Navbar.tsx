...
import { Menu, X, Sparkles, ChevronRight, Activity } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            <a
              href="#contact"
              className="text-xs font-semibold uppercase tracking-wider text-slate-400 hover:text-indigo-400 transition-colors px-3 py-2 flex items-center gap-1.5"
            >
            ...
            <div className="flex flex-col gap-3">
              {navLinks.map((link) => (
                <a
                  ...
                  className="px-3 py-2 text-base font-medium text-slate-200 hover:text-indigo-400 hover:bg-white/5 rounded-lg transition-colors"
                >
                  {link.name}
                </a>
              ))}
